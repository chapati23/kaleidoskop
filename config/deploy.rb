...
# repository location
set :repository, "git@github.com:pshizzle/kaleidoskop.git"
...
set :deploy_to, "/home/user25332258/rails1"
...
namespace :railshoster do
  ...
  task :appurl do
    ...
    puts "\nhttp://user25332258-1.rho.railshoster.de"    
    puts "\n"
  end
end
